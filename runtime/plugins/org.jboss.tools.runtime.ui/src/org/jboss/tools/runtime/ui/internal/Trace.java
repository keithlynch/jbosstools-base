...
public class Trace implements DebugOptionsListener {
	...
	public void optionsChanged(DebugOptions options) {
		Trace.CONFIG = options.getBooleanOption(RuntimeUIActivator.PLUGIN_ID + Trace.STRING_CONFIG, false);
		Trace.INFO = options.getBooleanOption(RuntimeUIActivator.PLUGIN_ID + Trace.STRING_INFO, false);
		Trace.WARNING = options.getBooleanOption(RuntimeUIActivator.PLUGIN_ID + Trace.STRING_WARNING, false);
		Trace.SEVERE = options.getBooleanOption(RuntimeUIActivator.PLUGIN_ID + Trace.STRING_SEVERE, false);
		Trace.FINER = options.getBooleanOption(RuntimeUIActivator.PLUGIN_ID + Trace.STRING_FINER, false);
		Trace.FINEST = options.getBooleanOption(RuntimeUIActivator.PLUGIN_ID + Trace.STRING_FINEST, false);
		Trace.RESOURCES = options.getBooleanOption(RuntimeUIActivator.PLUGIN_ID + Trace.STRING_RESOURCES, false);
		Trace.EXTENSION_POINT = options.getBooleanOption(RuntimeUIActivator.PLUGIN_ID + Trace.STRING_EXTENSION_POINT, false);
		Trace.LISTENERS = options.getBooleanOption(RuntimeUIActivator.PLUGIN_ID + Trace.STRING_LISTENERS, false);
	}
